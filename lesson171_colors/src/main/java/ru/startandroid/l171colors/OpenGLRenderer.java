package ru.startandroid.l171colors;
...
public class OpenGLRenderer implements Renderer {
    ...
    private void bindData() {
        ...
        которое занимают в нашем массиве данные по каждой вершине. У нас для каждой вершины
        заданы 5 float значений: 2 координаты (XY) и три компонента цвета (RGB). 5 float
        значений – это 5 * 4 байта = 20 байтов. Именно это значение мы и передаем в stride.*/
